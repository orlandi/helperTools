function varargout=sigstar(groups,stats,nosort)
    ...
    % Modified by Javier Orlandi for NETCAL. 2018, 2019
    ...
    H=cell(length(groups),1); %The handles will be stored here
...
function H=makeSignificanceBar(x,y,p)
    ...
    y=repmat(y,4,1);
    H = [];
    H = [H; plot(x(:),y,'-k','LineWidth',1,'Tag','sigstar_bar')];
